...
#define idxNumFunc 6
#define idxFunc 7
#define idxExtBtnS0 8
#define idxExtBtnS1 9
#define idxExtBtnS2 10
#define MAX_ELEM 11
...
void Loco::begin() {
  ...
  while(file.available()) {
    ...
    if (numElems > 0) {
      ...
      // Lokspezifische ext. Tastenbelegung
      if (numElems > idxExtBtnS0) if (elems[idxExtBtnS0] != "") loco->s0 = elems[idxExtBtnS0].toInt();
      if (numElems > idxExtBtnS1) if (elems[idxExtBtnS1] != "") loco->s1 = elems[idxExtBtnS1].toInt();
      if (numElems > idxExtBtnS2) if (elems[idxExtBtnS2] != "") loco->s2 = elems[idxExtBtnS2].toInt();
    }
  }
